...
const { addMeasurement, getMeasurementsByBatch, getLatestMeasurement, getTodayMeasurement, updateMeasurement, uploadBodyImages } = require('../controllers/measurementController');
...
router.get('/today/:batchId', protect, getTodayMeasurement);
