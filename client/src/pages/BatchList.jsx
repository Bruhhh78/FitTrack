    ...
    <div className="page-wrapper">
      <section className="section">
        <div className="container">
          <h1 className="section-title">Weight Loss <span style={{ color: 'var(--accent)' }}>Programs</span></h1>
          <p className="section-subtitle">Choose the program that fits your goals and start your transformation.</p>
          {batches.length === 0 ? (
            <div className="empty-state">
              <div className="empty-state-icon">📋</div>
              <h3>No Programs Available</h3>
              <p>Check back soon for new weight loss programs.</p>
            </div>
          ) : (
            <>
              {/* My Batches Section */}
                      ...
                      <div key={b._id} className="card card-interactive fade-in" style={{ animationDelay: `${i * 0.1}s`, overflow: 'hidden', padding: 0, border: '2px solid var(--accent)' }}>
                        ...
                        <div style={{ padding: 20 }}>
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Link to={`/dashboard/${b._id}`} className="btn btn-secondary btn-sm">Continue <FiArrowRight /></Link>
                          </div>
                        </div>
                      </div>
                    ))}
